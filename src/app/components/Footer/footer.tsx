...
export default function Footer() {
    return (
        <footer className="flex max-md:flex-col max-md:justify-start max-md:gap-6 max-md:px-10 md:justify-center md:items-center xl:gap-60 md:gap-10 lg:p-11 p-6  bg-black md:text-xl">
