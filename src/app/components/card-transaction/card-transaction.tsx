      ...
      <div className="flex flex-col gap-4">
        {depositos.map((deposito) => (
          <div key={deposito.id} className="flex flex-col md:flex-row justify-between md:items-center gap-2 bg-white py-2 px-4 rounded-lg">
            <ModalDeposito isOpen={isOpen} onClose={() => setIsOpen(false)} deposito={deposito} />
            ...
            <div className="flex gap-2">
              <button type="button" className="bg-my-dark-green p-2 rounded-full" onClick={() => setIsOpen(true)}>
                <Image src={lapis} alt="" />
              </button>
