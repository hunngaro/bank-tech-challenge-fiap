    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center " id="wrapper" onClick={(handleClose)}>
            <div className="xl:w-6/12 w-5/6 h-screen flex flex-col bg-my-light-gray">
                <button className="text-black text-xl place-self-end p-4" onClick={() => onClose()}>X
                </button>
                ...
                <div className="flex justify-start xl:ml-32 md:ml-20 w-3/4  p-8 ">
                    <form action="#">
                        <div>
                            ...
                            <input type="name" name="name" id="name" className="bg-white border-gray-300 mb-10 p-2 rounded-lg md:w-80" placeholder="Digite seu nome Completo" />
                        </div>
                        <div>
                            ...
                            <input type="email" name="email" id="email" className="bg-white border-gray-300 mb-10 p-2 rounded-lg md:w-80" placeholder="Digite seu E-mail" />
                        </div>
                        <div>
                            ...
                            <input type="password" name="password" id="password" className="bg-white border-gray-300 p-2 rounded-lg" placeholder="Digite sua senha" />
                        </div>
                    </form>
                </div>
            </div>
