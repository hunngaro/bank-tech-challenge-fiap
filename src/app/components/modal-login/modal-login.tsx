...
const Login: React.FC<LoginProps> = ({ isOpenLog, onCloseLog }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center ">
            <div className="fixed  inset-0 flex justify-center items-center  " id="wrapper" onClick={handleCloseLog}></div>
            <div className=" z-10 xl:w-5/12 w-5/6 h-screen flex flex-col bg-my-light-gray max-md:overflow-y-auto max-md:px-4 items-center ">
                <button className="text-black text-xl place-self-end md:p-4" onClick={() => onCloseLog()}>X
                </button>
                        ...
                        <div>
                            ...
                            <div className="mb-2">
                                ...
                                <input
                                    ...
                                    name="password"
                                    id="password"
                                    className="bg-white border-gray-200 border-2 p-2 rounded md:w-80" placeholder="Digite sua senha" />

                            </div>
                            <a href="#" className="text-my-green underline text-lg">Esqueci a senha!</a>
                        </div>
                        <div className="flex items-center justify-center mt-8">
                            <button type="submit" className="bg-my-green rounded-md w-[144px] h-[50px] mb-8 hover:opacity-70 hover:transition-opacity">Acessar</button>
                        </div>
                    </form>
                </div >
            </div >
