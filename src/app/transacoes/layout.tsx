...
export default function MeusCartoesLayout({ children }: Props) {
  return (
    <div className="flex flex-col flex-1 bg-my-light-green">
      <div className="flex px-6 md:px-[60px] lg:px-0">
        <div className="container mx-auto lg:grid lg:grid-cols-[180px_minmax(690px,_1fr)] lg:flex-row flex-grow gap-6 py-6 lg:px-0">
